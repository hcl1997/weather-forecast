...
public class Customer implements Serializable {
    ...
    public String getCustResume() {
        return custResume;
    }

    public void setCustResume(String custResume) {
        this.custResume = custResume;
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getCustId() == null ? other.getCustId() == null : this.getCustId().equals(other.getCustId()))
            ...
            && (this.getCustResume() == null ? other.getCustResume() == null : this.getCustResume().equals(other.getCustResume()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCustResume() == null) ? 0 : getCustResume().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", custResume=").append(custResume);
