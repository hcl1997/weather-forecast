...
public class JsonResult {
    ...
    /*返回结果的状态*/
    private ResultStatus status; //成功，失败，出错，需要登录。。
    /*返回结果的数据*/
    ...
    public static JsonResult createErrorJsonResult(Map<String,Object> data){
        return new JsonResult(ResultStatus.ERROR,data,"操作出错");
    }
    public static JsonResult createFailJsonResult(Map<String,Object> data){
        return new JsonResult(ResultStatus.FAIL,data,"操作失败");
    }
    public static JsonResult createNeedLoginJsonResult(Map<String,Object> data){
        return new JsonResult(ResultStatus.NEED_LOGIN,data,"需要登录");
    }
    public static JsonResult createHasLoginJsonResult(Map<String,Object> data){
        return new JsonResult(ResultStatus.HAS_LOGIN,data,"已经登录");
    }
